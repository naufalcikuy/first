...
urlpatterns = [
    ...
    url(r'^administrasi/$', views.show_admin, name='show_admin'),
    ...
    url(r'^show/knowledge/health$', views.show_health, name='show_health'),
    url(r'^show/knowledge/growing$', views.show_grow, name='show_grow'),
    url(r'^show/knowledge/development$', views.show_development, name='show_development'),
    url(r'^show/knowledge/immunization$', views.show_immun, name='show_immun'),
